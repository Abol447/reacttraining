function Navbar({ searchHandeller, search }) {
  return (
    <div className="flex px-2 items-center bg-gray-900 justify-between">
      <div className="flex items-center  text-white">
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <g fill="#ed3d23">
              {" "}
              <path d="M98.95 48.6s-.19-4-4.1-3.19c-4.1.84-4.14 4.97-4.14 4.97l-7.19 65.93l5.46-2.41l9.97-65.3z">
                {" "}
              </path>{" "}
              <path d="M109.39 39.02c-3.36 1.61-3.65 5.93-3.65 5.93l-11.45 66.62l5.37-2.38l13.51-69.84c-.01 0-.84-1.74-3.78-.33z">
                {" "}
              </path>{" "}
            </g>{" "}
          </g>
        </svg>
        <div className="font-bold text-3xl">popcorn</div>
      </div>
      <form action="" className="w-[40%]">
        <input
          value={search}
          onChange={(e) => searchHandeller(e)}
          className=" pl-2 border-2  w-full outline-0 border-purple-400"
          type="text"
        />
      </form>
      <div className="font-bold text-white text-xl">x result</div>
    </div>
  );
}
